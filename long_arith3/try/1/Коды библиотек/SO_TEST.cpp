...
extern "C" {
     BigInt*  BigInt_new(){ return new BigInt(); }
    void BigInt_get(BigInt* num,char* fname_in,char* bin ){ num->get(fname_in,bin);}
    void BigInt_save(BigInt* num,char* fname_in,char* bin ){ num->save(fname_in,bin);}
    BigInt* BigInt_power(BigInt* a,BigInt* b,BigInt*  mod){BigInt* ff=new BigInt(); ff[0]= power(a[0],b[0],mod[0]);return ff;}
   BigInt* BigInt_add(BigInt* a,BigInt* b){ BigInt* ff=new BigInt();ff[0]=a[0] + b[0];return ff;}
    BigInt* BigInt_sub(BigInt* a,BigInt* b){ BigInt* ff=new BigInt();ff[0]=a[0] - b[0];return ff;}
  BigInt* BigInt_mul(BigInt* a,BigInt* b){ BigInt* ff=new BigInt();ff[0]=a[0] * b[0];return ff;}
  BigInt* BigInt_div(BigInt* a,BigInt* b){ BigInt* ff=new BigInt();ff[0]=a[0] / b[0];return ff;}
   BigInt* BigInt_mod(BigInt* a,BigInt* b){ BigInt* ff=new BigInt();ff[0]=a[0] % b[0];return ff;}
}
